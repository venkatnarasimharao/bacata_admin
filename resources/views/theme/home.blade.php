			...
			@if(isset($slider) && count($slider) > 0)
				<div id="owl-main" class="owl-carousel">
					@foreach($slider as $key => $item)
						<a href="{{url('store-dtl/'.$item->title)}}" title="Store">
						<div class="slider-img item" style="background-image: url({{asset('images/slider/'.$item->image)}})">
						</div>
						</a>
					@endforeach
				</div>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="wide-banner cnt-strip">
						<div class="image"> <img class="img-responsive" src="{{asset('images/banner/online.png')}}" alt=""> </div>
					</div>
					<!-- /.wide-banner -->
				</div>
				<div class="col-md-6 col-sm-6">
					<div class="wide-banner cnt-strip">
						<div class="image"> <img class="img-responsive" src="{{asset('images/banner/offline.png')}}"  alt=""> </div>
					</div>
					<!-- /.wide-banner -->
				</div>
			</div>
...
<div class="container">
	...
	<div id="product-tabs-slider" class="scroll-tabs wow fadeInUp">
		...
		<div class="tab-content outer-top-xs">
									...
									<div class="product-image">
										<div class="image">
											<a href="deals-detail.html">
												<img src="{{asset('images/store/'.$item->image)}}"  alt="{{$item->title}}">
											</a>
										</div>
									</div>
			...
			@endif
			<!-- /.tab-pane -->
				@if(isset($featured_stores) && count($featured_stores) > 0)
					<div class="tab-pane in" id="featured">
						<div class="product-slider">
							<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
								@foreach($featured_stores as $item)
									<div class="item item-carousel">
										<div class="products">
											<div class="product">
												<div class="product-image">
