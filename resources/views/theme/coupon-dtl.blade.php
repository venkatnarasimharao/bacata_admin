												...
												<div class="row">
													...
													<div class="col-lg-7 col-8 border-l">
														<div class="coupon-dtl">
															...
															{{-- <h5 class="coupon-title"><a href="#" title="{{$item->title}}" data-toggle="modal" data-target="#coupon-id-{{$key}}">{{str_limit($item->title, 45)}}</a></h5> --}}
													...
													<div class="col-lg-3 text-center">
														<div class="grab-coupon-block">
															...
															<div class="grab-coupon-btn coupon-btn-outer">
																...
																<span>
					@auth
					<a href="#" data-toggle="modal" data-target="#coupon-id-{{$key}}">Get Coupon</a>
			        @else
