        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <?php echo Form::open(['method' => 'POST', 'action' => 'CommentController@bulk_delete', 'id' => 'bulk_delete_form']); ?>
          ...
          <tbody>
            <?php $__currentLoopData = $comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  <?php echo e($item->commentable->type == 'd' ? 'Deal' : $item->commentable->type == 'c' ? 'Coupon' : 'Discussion'); ?>

                </td>
                <td><?php echo e(str_limit($item->commentable->title, 20)); ?></td>
                <td><?php echo e($item->users->name); ?></td>
                <td><?php echo e($item->reply_id); ?></td>
                <td><?php echo str_limit($item->body,50); ?></td>
                <td>
                    <?php echo Form::open(['method' => 'POST', 'action' => ['CommentController@status_update', $item->id]]); ?>

                      <label class="switch">
                        <?php echo Form::checkbox('is_active', null, $item->is_active == 1 ? 1 : 0, ['class' => 'checkbox-switch', 'onChange'=>"this.form.submit()"]); ?>
                    ...
                    <div id="<?php echo e($item->id); ?>deleteModal" class="delete-modal modal fade" role="dialog">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <?php echo Form::open(['method' => 'DELETE', 'action' => ['CommentController@destroy', $item->id]]); ?>
