<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block">
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/user')); ?>" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Edit User</h4>
        ...
        <div class="row">
          ...
          <div class="col-md-6">            
            ...
            <div class="form-group<?php echo e($errors->has('points') ? ' has-error' : ''); ?>">
              <?php echo Form::label('points', 'Enter Points*'); ?> - <p class="inline info">Please enter points</p>
              <?php echo Form::text('points', null, ['class' => 'form-control', 'required']); ?>

              <small class="text-danger"><?php echo e($errors->first('points')); ?></small>
            </div> 
