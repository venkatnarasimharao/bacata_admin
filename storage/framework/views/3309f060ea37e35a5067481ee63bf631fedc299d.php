<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block mrgn-t-40">
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/coupon')); ?>" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Edit Coupon</h4> 
    <?php echo Form::model($coupon, ['method' => 'PATCH', 'action' => ['CouponController@update', $coupon->id], 'files' => true]); ?>
      ...
      <div class="row admin-form-block z-depth-1">
            ...
            <div class="row">
              ...
              <div class="col-md-2 pad-0">
                <div class="make-switch">
                  <?php echo Form::checkbox('type', null,$coupon->type == 'c' ? 1 : 0, ['class' => 'bootswitch', 'id' => 'CouponCheckBox', "data-on-text"=>"Coupon", "data-off-text"=>"Deal", "data-size"=>"small"]); ?>
        ...
        <div class="col-md-6"> 
          ...
          <div class="form-group<?php echo e($errors->has('forum_category_id') ? ' has-error' : ''); ?>">
              ...
              <?php echo Form::select('forum_category_id', $coupon->type == 'c' ? $cat_coupon : $cat_deal, null, ['class' => 'form-control select2', 'required']); ?>
          ...
          <div class="summernote-main form-group<?php echo e($errors->has('detail') ? ' has-error' : ''); ?>">
              ...
              <?php echo Form::textarea('detail', null, ['id' => 'summernote-main', 'class' => 'form-control']); ?>
        ...
        <div class="col-md-6"> 
          ...
          <div class="form-group<?php echo e($errors->has('is_exclusive') ? ' has-error' : ''); ?> switch-main-block">
            <div class="row">
              ...
              <div class="col-xs-5 pad-0">
                <label class="switch">                
                  <?php echo Form::checkbox('is_exclusive', null, null, ['class' => 'checkbox-switch']); ?>
          ...
          <div class="form-group<?php echo e($errors->has('is_verified') ? ' has-error' : ''); ?> switch-main-block">
            <div class="row">
              ...
              <div class="col-xs-5 pad-0">
                <label class="switch">                
                  <?php echo Form::checkbox('is_verified', null, null, ['class' => 'checkbox-switch']); ?>
