		...
		<div class="container">
			<div class="forum-page-header">
				<div class="forum-page-heading-block">
					<h5 class="forum-page-heading"><?php echo e($store->title); ?> Deals & Coupons</h5>
				</div>
			</div>
			<!-- breadcrumb -->
			<div id="breadcrumb" class="breadcrumb-main-block">
	          ...
	          <li><a href="<?php echo e(url('store')); ?>" title="Store">Stores</a></li>
								...
								<?php if(isset($category_list) && count($category_list)>0): ?>
									<div class="page-sidebar-widget categories-widget">
						      		...
						      		<div class="checkbox-main-group">
							      		<ul id="catList" class="form-group" data-store="<?php echo e($store->id); ?>" data-type="category">
