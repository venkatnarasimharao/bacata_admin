			...
			<div id="breadcrumb" class="breadcrumb-main-block">
				<div class="breadcrumb-block">
					<ol class="breadcrumb">
						...
						<li><a href="<?php echo e(url('coupon')); ?>" title="Coupons">Coupons</a></li>
								...
								<?php if(isset($category_list) && count($category_list)>0): ?>
									<div class="page-sidebar-widget categories-widget">
						      		...
						      		<div class="checkbox-main-group">
							      		<ul id="catList" class="form-group" data-store="<?php echo e($store->id); ?>" data-type="categorycoupon">
													...
													<div class="col-lg-3 text-center">
														<div class="grab-coupon-block">
															...
															<?php if($item->is_exclusive == 1): ?>
																<i class="far fa-star"></i>Coupon's Exclusive
															<?php else: ?>
																&nbsp;
															<?php endif; ?>
															</div>
															<div class="grab-coupon-btn coupon-btn-outer">
																...
																<span>
					<?php if(auth()->guard()->check()): ?>
					<a href="#" data-toggle="modal" data-target="#coupon-id-<?php echo e($key); ?>">Get Coupon</a>
			        <?php else: ?>
					<a href="#" data-toggle="modal" data-target="#login">Get Coupon</a>
			        <?php endif; ?>
