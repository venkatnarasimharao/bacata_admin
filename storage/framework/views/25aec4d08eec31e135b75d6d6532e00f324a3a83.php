<?php $__env->startSection('content'); ?>
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('pages.create')); ?>" class="btn btn-danger btn-md"><i class="material-icons left">add</i> Add Pages</a>
      <!-- Delete Modal -->
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <?php echo Form::open(['method' => 'POST', 'action' => 'PagesController@bulk_delete', 'id' => 'bulk_delete_form']); ?>
          ...
          <tbody>
            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td><?php echo substr(strip_tags($item->body), 0, 50); ?>...</td>
                <td><?php echo e($item->widget == '1' ? 'None' : ($item->widget == '2' ? 'Widget 1' : ($item->widget == '3' ? 'Widget 2' : 'Widget 3'))); ?></td>
                <td>
                  <div class="admin-table-action-block">
                    <a href="<?php echo e(route('pages.edit', $item->id)); ?>" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
                    <!-- Delete Modal -->
                    ...
                    <div id="<?php echo e($item->id); ?>deleteModal" class="delete-modal modal fade" role="dialog">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <?php echo Form::open(['method' => 'DELETE', 'action' => ['PagesController@destroy', $item->id]]); ?>
