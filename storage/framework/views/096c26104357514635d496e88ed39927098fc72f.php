...
<!-- slider start -->
	<section id="slider" class="home-slider container" >
			<?php if(isset($slider) && count($slider) > 0): ?>
				<div id="owl-main" class="owl-carousel">
					<?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<a href="<?php echo e(url('store-dtl/'.$item->title)); ?>" title="Store">
						<div class="slider-img item" style="background-image: url(<?php echo e(asset('images/slider/'.$item->image)); ?>)">
						</div>
						</a>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="wide-banner cnt-strip">
						<div class="image"> <img class="img-responsive" src="<?php echo e(asset('images/banner/online.png')); ?>" alt=""> </div>
					</div>
					<!-- /.wide-banner -->
				</div>
				<div class="col-md-6 col-sm-6">
					<div class="wide-banner cnt-strip">
						<div class="image"> <img class="img-responsive" src="<?php echo e(asset('images/banner/offline.png')); ?>"  alt=""> </div>
					</div>
					<!-- /.wide-banner -->
				</div>
			</div>
...
<div class="container">
	...
	<div id="product-tabs-slider" class="scroll-tabs wow fadeInUp">
		<div class="more-info-tab clearfix ">
			<h3 class="top-stores new-product-title  pull-left">Top Stores</h3>
			<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
				<li class="active"><a data-transition-type="backSlide" href="#recent" data-toggle="tab">Recent</a></li>
				<li><a data-transition-type="backSlide" href="#featured" data-toggle="tab">Featured</a></li>
				<li><a data-transition-type="backSlide" href="#trending" data-toggle="tab">Trending</a></li>
			</ul>
			<!-- /.nav-tabs -->
		</div>
		<div class="tab-content outer-top-xs">
			<?php if(isset($store_list) && count($store_list) > 0): ?>
			<div class="tab-pane in active show" id="recent">
									...
									<div class="product-image">
										<div class="image">
											<a href="deals-detail.html">
												<img src="<?php echo e(asset('images/store/'.$item->image)); ?>"  alt="<?php echo e($item->title); ?>">
											</a>
										</div>
									</div>
			...
			<?php endif; ?>
			<!-- /.tab-pane -->
				<?php if(isset($featured_stores) && count($featured_stores) > 0): ?>
					<div class="tab-pane in" id="featured">
						<div class="product-slider">
							<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
								<?php $__currentLoopData = $featured_stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="item item-carousel">
										<div class="products">
											<div class="product">
												<div class="product-image">
