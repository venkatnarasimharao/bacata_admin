		...
		<div class="container">
			<div class="forum-page-header">
				<div class="forum-page-heading-block">
					<h5 class="forum-page-heading"><?php echo e($category->title); ?> Deals & Coupons</h5>
				</div>
			</div>
			<!-- breadcrumb -->
			<div id="breadcrumb" class="breadcrumb-main-block">
	          ...
	          <li><a href="<?php echo e(url('category')); ?>" title="Categories">Categories</a></li>
								...
								<?php if(isset($store_list) && count($store_list)>0): ?>
									<div class="page-sidebar-widget categories-widget">
						      		...
						      		<div class="checkbox-main-group">
							      		<ul id="catList" class="form-group" data-store="<?php echo e($category->id); ?>" data-type="store">
