<?php $__env->startSection('content'); ?>
  <div class="content-main-block  mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('coupon.create')); ?>" class="btn btn-danger btn-md">Add Coupon/Deal</a>
      <!-- Delete Modal -->
              ...
              <tr>
                ...
                <td>
                  <?php if($item->image != null): ?>
                    <img src="<?php echo e(asset('images/coupon/'.$item->image)); ?>" class="img-responsive" width="80" alt="image">
                  <?php else: ?>
                    N/A  
                  <?php endif; ?>
                </td>
                <td><?php echo e($item->type == 'c' ? 'Coupon' : 'Deal'); ?></td>
                <td><?php echo e(str_limit($item->forumcategory->title, 20)); ?></td>
                <td><?php echo e(str_limit($item->title, 20)); ?></td>
                <td><?php echo e(strtok($item->store->title,' ')); ?></td>
                <td><?php echo e(strtok($item->category->title, ' ')); ?></td>
                
                
                <td><?php echo e(strtok($item->user->name,' ')); ?></td>
                <td><?php echo e($item->is_featured == '1' ? 'Featured' : 'Not'); ?></td>
               
                <td><?php echo e($item->is_verified == '1' ? 'Yes' : 'No'); ?></td>
                <td><?php echo e($item->is_active == '1' ? 'Active' : 'Deactive'); ?></td>
                <td>
                  <div class="admin-table-action-block">
                    <a href="<?php echo e(route('coupon.edit', $item->id)); ?>" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
                    <!-- Delete Modal -->
                    ...
                    <div id="<?php echo e($item->id); ?>deleteModal" class="delete-modal modal fade" role="dialog">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <?php echo Form::open(['method' => 'DELETE', 'action' => ['CouponController@destroy', $item->id]]); ?>
