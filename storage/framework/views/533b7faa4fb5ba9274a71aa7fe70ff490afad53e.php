...
<head>
<title><?php echo $__env->yieldContent('title'); ?> - <?php echo e($settings->w_title ? $settings->w_title : ''); ?></title>
<meta charset="utf-8" />
...
<script src="<?php echo e(asset('js/jquery-3.3.1.min.js')); ?>"></script>
	...
	<link href="<?php echo e(asset('css/blue.css')); ?>" rel="stylesheet" type="text/css"/>
<!-- jquery library js -->
<script>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="top-cart-row">
                                    <div class="link-cart">
                                        <div class="user-info">
                                            <div class="user-img">
                                                <img src="<?php echo e(asset('images/testimonials/member1.png')); ?>" alt="">
                                            </div>
                                                    ...
                                                    <div class="dropdown-menu single-menu nav-dropdown-menu" aria-labelledby="navbarDropdown3">
                                                        <div class="submenu-links first-submenu">
                                                            <ul>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link <?php echo e(Nav::isRoute('faq')); ?>" href="<?php echo e(url('contact')); ?>">FAQ's</a>
                                                                </li>
                                                                <li class="nav-item">
