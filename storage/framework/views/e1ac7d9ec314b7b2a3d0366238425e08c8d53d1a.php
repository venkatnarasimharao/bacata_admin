						...
						<div class="col-md-9">
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="ac-profile-block">
											...
											<h6 class="ac-username"><?php echo e($user->name); ?></h6>
											<div class="ac-post"><?php echo e($user->is_admin == '1' ? 'Administrator' : 'User'); ?></div>
										</div>
									</div>
									<div class="col-lg-9">
										<div class="ac-profile-dtl">
											<h6 class="ac-holder-name"><?php echo e($user->name); ?></h6>
											<div class="join-date">Joined Coupon on <?php echo e($user->created_at->format('jS F, Y')); ?></div>
											<div class="ac-holder-info">
												<p><?php echo e($user->brief); ?></p>
											</div>
										</div>
										<?php if(!isset($auth) || $auth->id != $user->id): ?>
											<div class="row">
												<div class="col-md-4">
													<div class="ac-btn">
														<?php if(auth()->guard()->check()): ?>
															<button type="button" id="follow-btn" class="btn-primary" data-follow="<?php echo e($user->id); ?>"><?php echo e($user->followers()->where('follower_id', $auth->id)->first() ? 'Unfollow' : 'Follow'); ?></button>
														<?php else: ?>
							...
							<div class="ac-facts account-box text-center">
								<div class="row">
									...
									<div class="col-lg-3 col-md-6">
										<div class="facts-block">
											<h1 id="count" class="fact-heading"><?php echo e($user->followers->count()); ?></h1>
											<h6 class="fact-name">Followers</h6>
										</div>
									</div>
									<div class="col-lg-3 col-md-6">
										<div class="facts-block">
											<h1 class="fact-heading"><?php echo e(count($user->followings)); ?></h1>
