<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block mrgn-t-40">
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/store')); ?>" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Add Store</h4> 
    <?php echo Form::open(['method' => 'POST', 'action' => 'StoreController@store', 'files' => true]); ?>
